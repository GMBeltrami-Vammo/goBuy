...
import { CircuitNet } from "@/components/circuit-net";
import "./globals.css";
...
const fxBootstrap = `(function(){try{var f=localStorage.getItem("gobuy-fx");if(f==="on")f="aurora";if(!f)f="circuit-static";var c=document.documentElement.classList;if(f==="aurora")c.add("fx-aurora");else if(f==="sphere")c.add("fx-sphere");else if(f==="circuit-static")c.add("fx-circuit-static");else if(f!=="off")c.add("fx-circuit");}catch(e){document.documentElement.classList.add("fx-circuit-static");}})();`;
